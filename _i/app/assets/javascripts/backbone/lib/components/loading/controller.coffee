@CashFlow.module 'Components.Loading', (Loading, App, Backbone, Marionette, $, _) ->
  class Loading.LoadingController extends App.Controllers.Application
    initialize: (options) ->
#      console.log 'initialize loading controller1', @
      {view, config} = options
...
#      console.log 'initialize loading controller2', @
...
#            @region.currentView.$el.removeAttr 'style'
  ...
  #    onClose: ->
  #      console.log 'close loading controller', @
